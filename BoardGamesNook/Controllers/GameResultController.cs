...
namespace BoardGamesNook.Controllers
{
    public class GameResultController : Controller
    {
        ...
        private readonly GameResultService gameResultService = new GameResultService(new GameResultRepository());
        ...
        public JsonResult Get(int id)
        {
            ...
            var gameResultViewModel =
                GameResultMapper.MapToGameResultViewModel(gameResult, gamerService.Get(gameResult.CreatedGamerId));
        ...
        public JsonResult GetAll()
        {
            ...
            var gameResultListViewModel = GameResultMapper.MapToGameResultViewModelList(gameResultList,
                gamerService.Get(gameResultList.Select(x => x.GamerId).FirstOrDefault()));
        ...
        public JsonResult Edit(int gameResultId)
        {
            ...
            var dbGameResult = gameResultService.Get(gameResultId);
